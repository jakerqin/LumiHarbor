...
const HIGHLIGHT_COLORS: BubbleColorMenuItem[] = [
  ...
  { name: "Purple", color: "#3f2c4b" },
  { name: "Red", color: "#5c1a1a" },
  { name: "Yellow", color: "#5c4b1a" },
  { name: "Blue", color: "#1a3d5c" },
  { name: "Green", color: "#1a5c20" },
  { name: "Orange", color: "#5c3a1a" },
  { name: "Pink", color: "#5c1a3a" },
